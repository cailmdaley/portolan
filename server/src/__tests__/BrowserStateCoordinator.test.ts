    ...
    const coordinator = new BrowserStateCoordinator({
      ...
      getMeetingState: () => ({
        activeMeeting: {
          ...
          assistantResponsesPath: '/tmp/assistant-responses.jsonl',
          candidateEventsPath: '/tmp/candidate-events.jsonl',
          candidatePromotionsPath: '/tmp/candidate-promotions.jsonl',
          retrievalRequestsPath: '/tmp/retrieval-requests.jsonl',
          retrievalEvidencePath: '/tmp/retrieved-evidence.jsonl',
