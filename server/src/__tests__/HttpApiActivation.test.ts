...
describe('HttpApiActivation', () => {
  ...
  it('short-circuits activation when the preferred runtime is already connected', async () => {
    ...
    expect(result()).toEqual({
      ...
      body: {
        ...
        message: 'Agent (rust) already connected on candide',
        preferredRuntime: 'rust',
      },
    });
  });
