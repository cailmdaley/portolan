...
Cite in fiber outcomes as inline code: `results/references/2601.10038.tex:L79`. The tapestry renders this as a clickable link (the link format accepts `:L42` and `:L42-55`). In the interactive tapestry, clicking opens the file at that line in your editor. In the static tapestry, the link opens the file path directly.
