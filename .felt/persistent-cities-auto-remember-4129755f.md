...
close-reason: 'Implemented persistent cities: auto-remember on session discovery, dormant state tracking (isDormant), muted color for dormant cities, click dormant remote → POST /activate-city → SSH + start hexarchy-agent.'
---
