...
close-reason: 'Added to fiber but keeping open - scroll improvements made (overflow-y: scroll, -webkit-overflow-scrolling: touch, overscroll-behavior: contain). Still may need testing.'
---
