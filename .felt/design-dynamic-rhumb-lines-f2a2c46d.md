...
close-reason: 'Deferred for now. Reduced rose count instead: 1 primary + 3 secondary (was 2+6). Lowered opacity to 0.30/0.18. The deeper design question (functional vs decorative rhumb lines, city-anchored roses) remains open for future iteration.'
---
